...
{
    public class GetAllNewRoomHandler : IRequestHandler<GetAllNewRoomQuery, ObjectResult>
    {
        private readonly IRoomRepository roomRepository;
        private readonly IMapper mapper;
        private readonly ProfileService.ProfileServiceClient client;
        private readonly ILogger<GetAllNewRoomHandler> logger;

        public GetAllNewRoomHandler(IConfiguration configuration, IRoomRepository roomRepository, IMapper mapper, ILogger<GetAllNewRoomHandler> logger)
        {
        ...
        public async Task<ObjectResult> Handle(GetAllNewRoomQuery request, CancellationToken cancellationToken)
        {
