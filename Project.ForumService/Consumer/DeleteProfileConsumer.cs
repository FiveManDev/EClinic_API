...
namespace Project.ForumService.Consumer
{
    public class DeleteProfileConsumer : IConsumer<DeleteProfileEvents>
    {
        ...
        public DeleteProfileConsumer(IMongoDBRepository<Post> postRepository, IMongoDBRepository<Answer> answerRepository, IMongoDBRepository<Comment> commentRepository, ILogger<DeleteProfileConsumer> logger, IBus bus)
        {
