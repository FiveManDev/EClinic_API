...
//using Project.ServiceInformationService.Dtos.Specialization;
...
//        try
//        {
//            var services = await repository.GetAllAsync(x => x.IsActive);
//            if (services == null)
//            {
...
//            return ApiResponse.OK<List<SpecializationDTO>>(serviceDTOs);
//        }
//        catch (Exception ex)
//        {
