...
{
    public class GetBlogsHandler : IRequestHandler<GetBlogsQuery, ObjectResult>
    {
        ...
        public GetBlogsHandler(IMongoDBRepository<Blog> blogRepository, IMongoDBRepository<Hashtag> hashtagRepository, IMapper mapper, ILogger<GetBlogsHandler> logger)
        {
        ...
        public async Task<ObjectResult> Handle(GetBlogsQuery request, CancellationToken cancellationToken)
        {
            try
            {
