...
{
    public class GetAllBlogHandler : IRequestHandler<GetAllBlogQuery, ObjectResult>
    {
        private readonly IMongoDBRepository<Blog> repository;
        private readonly IMongoDBRepository<Hashtag> hashTagRepository;
        private readonly IMapper mapper;
        private readonly ILogger<GetAllBlogHandler> logger;
        public GetAllBlogHandler(IMongoDBRepository<Blog> repository, IMongoDBRepository<Hashtag> hashTagRepository, IMapper mapper, ILogger<GetAllBlogHandler> logger)
        {
        ...
        public async Task<ObjectResult> Handle(GetAllBlogQuery request, CancellationToken cancellationToken)
        {
            try
            {
