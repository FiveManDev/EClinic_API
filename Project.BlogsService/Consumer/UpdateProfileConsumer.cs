...
//        public UpdateProfileConsumer(IMongoDBRepository<Blog> postRepository, IMongoDBRepository<Answer> answerRepository, IMongoDBRepository<Comment> commentRepository, ILogger<DeleteProfileConsumer> logger, IBus bus)
//        {
